            ...
            <table style={_.assign({}, { borderCollapse: 'collapse'}, widthStyle ? widthStyle : {})}>
                <thead>
                {
                    _.map(tableHeader, (headerList, trindex) => {
                        return (
                            <tr key={'thead-tr-' + trindex} className={headRowClassName ? headRowClassName : 'thead-row'} >
                                {
                ...
                <tbody>
                {
                    _.map(showData, (rowData, trindex) => {
                        return (
                            <tr className={bodyRowClassName ? bodyRowClassName : 'tbody-row'} key={'tbody-tr-' + trindex} onMouseEnter={handleRowMouseEnter ? handleRowMouseEnter.bind(null, rowData) : this.emptyFn} >
                                {
...
class TableViewComponent extends React.Component {
    ...
    render() {
        ...
        var {tableHeader, tableData, cancelTableSort, customSort, cancelDownload, headRowClassName, bodyRowClassName, handleRowMouseEnter} = this.props;
