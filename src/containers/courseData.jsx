...
import mockData from '../mockData/course.json';
    ...
    render() {
        return (
            <div className='report' >
                ...
                { this.state.option.value === '课程数据统计' ? <CourseStatis data={mockData} /> : null }
                { this.state.option.value === '课程数据详情' ? <CourseDetail data={mockData.detail} /> : null }
            </div>
        )
    }
}