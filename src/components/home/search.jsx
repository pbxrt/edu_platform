        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div style={{ position: 'relative'}} >
                    <i className='search' />
                    <input style={{ width: 700, height: 40, color: '#666', paddingLeft: 40, fontSize: 14, border: 'none', borderRadius: 3 }} type='text' value={this.state.text} onChange={this.handleOnChange.bind(this)} placeholder='搜索：区县、学校、老师' />
                </div>
